...
module.exports.onChat = async ({ api, event }) => {
  try {
    ...
    if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("janu")) {
      ...
      if (!arr) {
        return api.sendMessage("tui poca tor shata kono kota ni soytan care 🥹🥹","eto bot bot koris ken 🐸","amake na dake amer boss Robiul er inbox a massage koro","বেশি ডাকলে চুম্মাইয়া ঠোঁটের কালার চেন্জ করে দিবো 😾", প্রেম সবাই করে আর দোষ হয় আমার বস রবিউল এর🥹","একটা ভাঙ্গা চুরা জিএফ লাগবো 😓 ","তুই বট তোর নানি বট তোর কত বড় সাহস তুই আমাকে বট বলে তোরটা খায় নাকি পড়ি 😾","প্রেম ভালোবাসা বলতে কিছু নেই এইসব প্রেম না খাওয়ার ধান্দা 😼", event.threadID, (error, info) => {
          global.GoatBot.onReply.set(info.messageID, {
            commandName: module.exports.config.name,
            type: "reply",
            messageID: info.messageID,
